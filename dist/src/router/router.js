...
const musicController_1 = __importDefault(require("../controller/musicController"));
const router = (0, express_1.Router)();
router.get('/home_af', blogController_1.default.showAll);
router.get('/information', userController_1.default.pageInfor);
router.get('/createBlog', pageController_1.default.pageAddBlog);
...
router.get('/music', musicController_1.default.showMusic);
router.get('/createMusic', pageController_1.default.pageAddMusic);
router.post('/createMusic', musicController_1.default.addNewMusic);
router.get('/searchSong', musicController_1.default.searchMusic);
